...
class We7_doctorModule extends WeModule {
	public $weid;
	...
	public function fieldsFormSubmit($rid) {
		...
		global $_W,$_GPC;
			if ($_GPC['we7_ValidCode_server']==$_GPC['we7_ValidCode_server']) {		
			$data = array(
				'rid'             => $rid,
				'weid'            => $_W['weid'],
				'title'           => $_GPC['title'],
			...
			//print_r($_GPC['shouquan']);print_r('+++');print_r($_GPC['we7_ValidCode_server']);exit;
