...
class DBUtil
{
    ...
    public static $TABLE_XKWKJ = "we7_weikanjia";

    public static $TABLE_XKWKJ_USER = "we7_weikanjia_user";

    public static $TABLE_XKWKJ_FIREND = "we7_weikanjia_firend";

    public static $TABLE_XKWJK_ORDER = "we7_weikanjia_order";

    public static $TABLE_XKWKJ_SETTING = "we7_weikanjia_setting";
