...
define("we7_weikanjia_RES", "../addons/" . we7_weikanjia . "/");
require_once IA_ROOT . "/addons/" . we7_weikanjia . "/dbutil.class.php";
require IA_ROOT . "/addons/" . we7_weikanjia . "/oauth2.class.php";
require_once IA_ROOT . "/addons/" . we7_weikanjia . "/value.class.php";
require_once IA_ROOT . "/addons/" . we7_weikanjia . "/monUtil.class.php";
require_once IA_ROOT . "/addons/" . we7_weikanjia . "/WxPayPubHelper/WxPayPubHelper.php";

/**
 * Class Mon_WkjModuleSite
 */
class we7_weikanjiaModuleSite extends WeModuleSite
{
	public $weid;
	public $acid;
	public $oauth;
	...
	public function  createFirendKj($xkwkj, $uid, $fopenid, $fnickname, $fheadimgurl, $seq_weapon, $name_seq)
	{
		...
		if ($dayKjCount >= $xkwkj['day_help_count']) {
			return array(0,0, "亲，今天帮看好友名额已够，明天再来帮好友砍价吧！");
		}
	...
	public function toPayTemplate($user,$orderInfo, $xkwkj) {
		...
		$notifyUrl = $_W['siteroot'] . "addons/" . we7_weikanjia . "/notify.php";
	...
	public function  doMobileAuth()
	{
		...
		$params['au'] = $au;
		$params['uid'] = $uid;
		$userInfo = MonUtil::getClientCookieUserInfo(we7_weikanjiaModuleSite::$USER_COOKIE_KEY . "" . $kid);
