...
<head>
	...
	<title><?php  if(!empty($title)) { ?> <?php  echo $title;?> <?php  } else if(!empty($_W['page']['title'])) { ?> <?php  echo $_W['page']['title'];?><?php  } ?><?php  if(!empty($_W['page']['sitename'])) { ?> - <?php  echo $_W['page']['sitename'];?><?php  } else { ?> - <?php  echo $_W['account']['name'];?><?php  } ?><?php  if(IMS_FAMILY != 'x') { ?> - Powered by WE7.CC<?php  } ?></title>
	...
	<link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>app/themes/default/css/footer.css"/>
