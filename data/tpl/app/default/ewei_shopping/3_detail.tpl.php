    ...
    <div class="detail-div img-rounded">
        ...
        <div class="detail-group" style='margin-top:10px;'>
			<span class="col-xs-8" style="width:100%;">
				<?php  if($marketprice==$originalprice || $originalprice == '0.00') { ?>
				现价 : ¥ <span id='marketprice' class="text-danger" style="font-size:18px; font-weight:bold;"><?php  echo $marketprice;?></span> <?php  if(!empty($goods['unit'])) { ?>元&nbsp;/ <?php  echo $goods['unit'];?><?php  } ?>
				<?php  } else { ?>
		   	 	现价 : ¥ <span class="text-danger" id='marketprice' style="font-size:18px; font-weight:bold;"><?php  echo $marketprice;?> 元&nbsp;/ <?php  echo $goods['unit'];?></span> <span
                    id='productpricecontainer' >  原价 : <del
                    style="font-size:14px; ">¥ <span id='productprice'><?php  echo $originalprice;?></span>元&nbsp; / <?php  echo $goods['unit'];?></del></span>
				<?php  } ?>
			</span>
        </div>
